                        ...
                        <div class="col-lg-10 offset-lg-1">
                            <div class="cart_container">
                                                ...
                                                <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                                    ...
                                                    <div class="cart_item_total cart_info_col">
                                                        ...
                                                        <div class="cart_item_text">
                                                            <button class="btn btn-danger btn-sm delete mr-4" data-id="{{ $item->getProductid() }}"><i class="fa-solid fa-trash"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                ...
                                <div class="cart_buttons">
                                    ...
                                    <button type="button" class="button cart_button_checkout"><i class="fa fa-credit-card"></i> Zapłać</button>
                                </div>
                            </div>
                        </div>
                    </div>
